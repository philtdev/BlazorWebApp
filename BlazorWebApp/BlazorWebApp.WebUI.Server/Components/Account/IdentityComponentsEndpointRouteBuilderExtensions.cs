using BlazorWebApp.WebUI.Server.Components.Account.Pages;
using BlazorWebApp.WebUI.Server.Components.Account.Pages.Manage;
...
namespace BlazorWebApp.WebUI.Server.Components.Account;
